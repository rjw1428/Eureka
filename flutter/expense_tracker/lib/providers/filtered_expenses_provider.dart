...
final filteredExpensesProvider = Provider<AsyncValue<List<ExpenseWithCategoryData>>>((ref) {
  ...
  return expenses$.when(
    ...
    data: (expenses) {
      ...
      final filteredList =
          expenses.where((expense) => selectedFilters.contains(expense.categoryId)).toList();
